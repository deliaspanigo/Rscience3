...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, code_internal = FALSE, code_external = FALSE}
# 
...
```{r eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, code_internal = TRUE, code_external = TRUE}
# # # # # Section 01 - Libraries ---------------------------------------------
...
```{r eval=FALSE, echo=TRUE, code_internal = FALSE, code_external = TRUE}
# El external
# # # # # Section 02 - Import dataset ----------------------------------------
my_dataset <- __import_external_my_dataset__
head(x = my_dataset, n = 5)
```

```{r eval=TRUE, echo=FALSE, code_internal = TRUE, code_external = FALSE}
# El internal
# # # # # Section 02 - Import dataset ----------------------------------------
my_dataset <- __import_internal_my_dataset__
head(x = my_dataset, n = 5)
```
...
```{r eval=TRUE, echo=TRUE, code_internal = TRUE, code_external = TRUE}
# # # # # Section 03 - Settings ----------------------------------------------
  var_name_rv     <- __var_name_rv__
  var_name_rv

  var_name_factor <- __var_name_factor__
  var_name_factor

  alpha_value     <- __alpha_value__
  alpha_value

  vector_ordered_levels <- __vector_ordered_levels__
  vector_ordered_levels
  
  vector_ordered_colors <- __vector_ordered_colors__
...
{{< include report01_lab00_original_RQuarto_02_appendix01_sec13_Descriptive_RV.qmd >}}

# Section 14 - Descritive for Residuals
{{< include report01_lab00_original_RQuarto_03_appendix02_sec14_Descriptive_Residuals.qmd >}}


{{< include report01_lab00_original_RQuarto_04_appendix03_sec15_to_17_ASA.qmd >}}


```{r eval=FALSE, echo=TRUE, code_internal = FALSE, code_external = FALSE}
