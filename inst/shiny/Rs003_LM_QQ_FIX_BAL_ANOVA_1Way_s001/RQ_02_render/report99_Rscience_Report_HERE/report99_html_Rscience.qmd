...
# Folders
str_output_folder <- list_config$external_output$str_user_output_folder_path


# Input paths
str_input_file_path_RData   <- list_config$external_inputs$list_external_input_file_path$str_RData
