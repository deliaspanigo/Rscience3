...
module_theory_server <- function(id) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    # 4. Loading my fns
    str_fn_app_general <- "fn_app_general.R" #here::here("fn_app_general.R")
    str_fn_app_html <- "fn_app_html.R" #here::here("fn_app_html.R")
    ...
    str_source_folder_full_path <- file.path("RQ_01_ready", "theory_quarto_files")#here::here("..", "RQ_01_ready", "theory_quarto_files")
