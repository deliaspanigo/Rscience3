...
# El external
# # # # # Section 02 - Import dataset ----------------------------------------
my_dataset <- _import_external_my_dataset_
...
# El internal
# # # # # Section 02 - Import dataset ----------------------------------------
my_dataset <- _import_internal_my_dataset_
head(x = my_dataset, n = 5)
```
...
# # # # # Section 03 - Settings ----------------------------------------------
  ...
  vector_ordered_levels <- _vector_ordered_levels_
  vector_ordered_levels
  
  vector_ordered_colors <- _vector_ordered_colors_
...
{{< include report01_RQuarto_99_appendix01_sec13_Descriptive_RV.qmd >}}

# Section 14 - Descritive for Residuals
{{< include report01_RQuarto_99_appendix02_sec14_Descriptive_Residuals.qmd >}}


{{< include report01_RQuarto_99_appendix03_sec15_to_17_ASA.qmd >}}


```{r eval=TRUE, echo=TRUE, code_internal = FALSE, code_external = FALSE}
