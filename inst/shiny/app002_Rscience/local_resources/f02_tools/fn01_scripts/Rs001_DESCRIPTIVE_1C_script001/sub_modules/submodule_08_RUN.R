  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    pipeline_list <- shiny::reactive({
      ...
      list(
        ...
        "action02" = list(description = "HTML Report Generation", qmd_file = find_file_recursively(root, "fn02_gen_RQuarto_report_STONE\\.qmd$"), output_pattern = "zzz_zzz_output/zzz_output_fn01_RQuarto_Report_MOD\\.html$", export_name = "Report.html", dependencies = c("action01")),
        ...
        "action04" = list(description = "Data Environment (RData)", qmd_file = find_file_recursively(root, "fn04_gen_RData_from_Rscript_internal_STONE\\.qmd$"), output_pattern = "zzz_zzz_output/zzz_output_fn04_RData_Rscript_internal\\.RData$", export_name = "Data.RData", dependencies = c("action03")),
        ...
        "action07" = list(description = "Report Revealjs", qmd_file = find_file_recursively(root, "fn07_gen_reveajs_STONE\\.qmd$"), output_pattern = "zzz_zzz_output/zzz_output_fn07_gen_reveajs_RUNNER\\.html$", export_name = "Revealjs_Report.html", dependencies = c("action04")),
