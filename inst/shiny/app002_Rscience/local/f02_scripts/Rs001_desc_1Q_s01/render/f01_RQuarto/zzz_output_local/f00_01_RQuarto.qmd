---
title: "Sección 13 - Estadística Descriptiva"
format: 
 html:
...
```{r, code_internal = TRUE, code_external = TRUE}
...
# 13.1 - Tabla de Métricas Principales
Se calculan las medidas de tendencia central, dispersión y forma para la variable respuesta.
...
# 13.2 - Análisis de Percentiles
Fragmentación de la muestra en posiciones de frecuencia acumulada.
...
# 13.3 - Visualización Interactiva
...
[Image of a box plot showing quartiles and outliers]
