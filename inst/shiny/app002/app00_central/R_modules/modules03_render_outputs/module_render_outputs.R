...
module_render_outputs_server <- function(id, app_state) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    # Loading my fns
    str_fn_app_inputs <- here("fn_app_inputs.R")
    str_fn_app_general <- here("fn_app_general.R")
    ...
    # =====================================================================
    str_steps_folder_path <- here("R_modules", "modules03_render_outputs", "pipeline_proc_steps")
    
    # Step 01 ------------------------------------------------------------------
    # Preparing work output temporal folder and sys time.
    str_step01_file_name <- "fn_proc_step01_temp_work_folder_and_time.R"
    str_step01_file_path <- file.path(str_steps_folder_path, str_step01_file_name)
    source(str_step01_file_path)
    fn_proc_step01_temp_work_folder_and_time(state, my_pipeline_steps, list_bag_steps, the_timer, advance_step_trigger)
    
    
    # Step 02 ------------------------------------------------------------------
    # Coping file from package to work temporal folder.
    str_step02_file_name <- "fn_proc_step02_copy_files.R"
    str_step02_file_path <- file.path(str_steps_folder_path, str_step02_file_name)
    source(str_step02_file_path)
    ...
    # Step 03 ------------------------------------------------------------------
    # Rendering...
    # Folder: report01_RQuarto_HERE
    # File: report01_RQuarto_00.qmd
    str_step03_file_name <- "fn_proc_step03_quarto_report01.R"
    str_step03_file_path <- file.path(str_steps_folder_path, str_step03_file_name)
    source(str_step03_file_path)
    fn_proc_step03_quarto_report01(state, my_pipeline_steps, list_bag_steps, set_default_quiet, advance_step_trigger) 
    
    # Step 04 ------------------------------------------------------------------
    # Folder: report02_R_script_HERE
    # File: report02_R.qmd
    str_step04_file_name <- "fn_proc_step04_quarto_report02.R"
    str_step04_file_path <- file.path(str_steps_folder_path, str_step04_file_name)
    source(str_step04_file_path)
    fn_proc_step04_quarto_report02(state, my_pipeline_steps, list_bag_steps, set_default_quiet, advance_step_trigger)
    
    
    
    # Step 05 ------------------------------------------------------------------
    # Folder: report03_pdf_HERE
    # File: report03_pdf.qmd
    str_step05_file_name <- "fn_proc_step05_quarto_report03.R"
    str_step05_file_path <- file.path(str_steps_folder_path, str_step05_file_name)
    source(str_step05_file_path)
    fn_proc_step05_quarto_report03(state, my_pipeline_steps, list_bag_steps, set_default_quiet, advance_step_trigger)
    
    
    # Step 06 ------------------------------------------------------------------
    # Folder: report04_docx_HERE
    # File: report04_docx.qmd
    str_step06_file_name <- "fn_proc_step06_quarto_report04.R"
    str_step06_file_path <- file.path(str_steps_folder_path, str_step06_file_name)
    source(str_step06_file_path)
    fn_proc_step06_quarto_report04(state, my_pipeline_steps, list_bag_steps, set_default_quiet, advance_step_trigger)
    
    
    
    # Step 07 ------------------------------------------------------------------
    # Folder: report05_xlsx_HERE
    # File: report05_xlsx.qmd
    str_step07_file_name <- "fn_proc_step07_quarto_report05.R"
    str_step07_file_path <- file.path(str_steps_folder_path, str_step07_file_name)
    source(str_step07_file_path)
    fn_proc_step07_quarto_report05(state, my_pipeline_steps, list_bag_steps, set_default_quiet, advance_step_trigger)
    
    
    
    # Step 08 ------------------------------------------------------------------
    # Folder: report06_revealjs_HERE
    # File: report06_revealjs.qmd
    str_step08_file_name <- "fn_proc_step08_quarto_report06.R"
    str_step08_file_path <- file.path(str_steps_folder_path, str_step08_file_name)
    source(str_step08_file_path)
    ...
    # Step 09 ------------------------------------------------------------------
    # Folder: report99_Rscience_Report_HERE
    # File: report99_Rscience_Report_00.qmd
    str_step09_file_name <- "fn_proc_step09_quarto_report99.R"
    str_step09_file_path <- file.path(str_steps_folder_path, str_step09_file_name)
    source(str_step09_file_path)
