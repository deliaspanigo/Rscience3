...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{source}\NormalTok{(}\StringTok{"fns.R"}\NormalTok{)}
...
\begin{verbatim}
Error in as_pixels_int(vwidth): `vwidth` must be an integer number of pixels, not '100%'.
\end{verbatim}
...
The p-value for the ANOVA test is 4.97891917440023e-09. The alpha value
